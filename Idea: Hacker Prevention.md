...
### find some people to check the hackers, They can watch in diffirent lobbies  
  - they can go to the hackers lobbies and get name (or maybe anonymous?)
  - they can use ```/sus 1 ~ 4``` 
  - 1 is not suspicious, and 4 is evidence without doubt
  - They **CAN'T BAN** them, need to ban by authur
